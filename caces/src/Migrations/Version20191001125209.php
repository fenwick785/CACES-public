 ...
 */
final class Version20191001125209 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD role JSON NOT NULL, DROP roles, CHANGE reset_token reset_token VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE result_evaluate CHANGE id_user_id id_user_id INT DEFAULT NULL, CHANGE res_total res_total INT DEFAULT NULL, CHANGE res1 res1 INT DEFAULT NULL, CHANGE res2 res2 INT DEFAULT NULL, CHANGE res3 res3 INT DEFAULT NULL, CHANGE res4 res4 INT DEFAULT NULL, CHANGE res5 res5 INT DEFAULT NULL');
        $this->addSql('ALTER TABLE user ADD roles LONGTEXT NOT NULL COLLATE utf8mb4_bin, DROP role, CHANGE reset_token reset_token VARCHAR(255) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
