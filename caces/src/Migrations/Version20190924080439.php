 ...
 */
final class Version20190924080439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE lesson (id INT AUTO_INCREMENT NOT NULL, chapter VARCHAR(255) NOT NULL, part VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, video VARCHAR(255) DEFAULT NULL, t1 VARCHAR(255) DEFAULT NULL, p1 LONGTEXT DEFAULT NULL, t2 VARCHAR(255) DEFAULT NULL, p2 LONGTEXT DEFAULT NULL, t3 VARCHAR(255) DEFAULT NULL, p3 LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
